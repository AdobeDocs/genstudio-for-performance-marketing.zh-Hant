...
* [TikTok廣告](tiktok-experiences.md)
* [ChatGPT廣告](create-chatgpt-ad.md)
* [連線電視廣告](create-ctv.md)
...
選取您要在&#x200B;_今天要建立什麼？_&#x200B;中產生哪個頻道 區段，您可以存取品牌核准的範本以用於內容產生。 使用範本可快速開始內容建立流程，並與定義的品牌識別保持一致。
...
您可以從[!DNL Create]登陸頁面或[!DNL Content]將核准的電子郵件和付費媒體體驗翻譯成多種語言。 請參閱[翻譯及本地化體驗](/help/user-guide/create/translate-experiences.md)。
