...
[!DNL Create]可讓現代行銷人員運用[指南](/help/user-guide/create/create-banner-experience.md)、影像資產和[精心打造的提示](/help/user-guide/guidelines/overview.md)，以[製作有凝聚力的橫幅體驗](/help/user-guide/effective-prompts.md)。

產生橫幅體驗時，會建立四個變數並顯示在畫布中。

請參閱[遵循特定管道的範本准則](/help/user-guide/templates/best-practices-for-templates.md#follow-channel-specific-template-guidelines)，以取得支援的維度、可辨識的欄位名稱等相關資訊。
