...
**若要將GenStudio for Performance Marketing與您的中繼帳戶連線**：

1. 從&#x200B;_設定_，按一下「中繼廣告」方塊上的&#x200B;**[!UICONTROL 連線]**。 _中繼廣告帳戶_&#x200B;檢視開啟。

1. 如果出現提示，請從瀏覽器選取&#x200B;**[!UICONTROL 允許快顯視窗]**。

1. 選取要連線的一或多個廣告帳戶，然後按一下[選取]。****
...
_主要文字_&#x200B;和&#x200B;_標題_&#x200B;僅由GenStudio for Performance Marketing所需，不需要Meta。
