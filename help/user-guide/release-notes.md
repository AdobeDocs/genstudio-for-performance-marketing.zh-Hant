...
現在，您可以依照靜態LinkedIn廣告所使用的端對端啟用流程，從GenStudio for Performance Marketing將使用單一視訊資產](/help/user-guide/activation/activate-linkedin-ad.md)的LinkedIn廣告體驗[啟用至LinkedIn行銷活動管理員。
...
* 針對Meta廣告行銷活動，使用彈性的轉換追蹤](/help/user-guide/insights/ads.md)分析[每次動作成本(CPA)。
...
[!DNL Insights]模組中的新篩選器會自動從廣告預覽中隱藏[不支援的影像和視訊資產](/help/user-guide/insights/ads.md#ad-formats)，消除視覺雜訊和損毀的圖磚。 此增強功能可確保使用者只看到實際可用且可立即使用的媒體，進而建立更乾淨且更可靠的體驗。 此篩選器可與現有的相容性廣告篩選器搭配使用。
