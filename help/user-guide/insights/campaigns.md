...
[!DNL Insights] _[!UICONTROL 行銷活動]_&#x200B;檢視會顯示已連線頻道廣告帳戶的行銷活動清單。

{{connect-insights}}

_[!UICONTROL 行銷活動]_&#x200B;表格是使用頻道型廣告行銷活動來組織。 按一下表格右上方的設定(cog)圖示，以切換可檢視欄。

![行銷活動篩選器和表格](/help/assets/insights-campaigns-filter.png){zoomable="yes"}

選取行銷活動時，[[!UICONTROL 廣告]標籤](published-experiences.md)會開啟至與該行銷活動相關聯的廣告名稱清單，讓您識別哪些廣告促成了其整體成功。
