...
設定GenStudio for Performance Marketing與您的付費媒體帳戶之間的連線，以接收來自作用中行銷活動、資產和體驗的資料。 使用Meta和LinkedIn時，使用[!DNL Insights]分析管道衍生的資料，包括&#x200B;**[!UICONTROL Insights 2.0]**&#x200B;跨管道概觀（[Insights概觀](/help/user-guide/insights/overview.md#insights-20)）。 請參閱[連線付費媒體帳戶](/help/user-guide/connectors/connect-channel.md)。
