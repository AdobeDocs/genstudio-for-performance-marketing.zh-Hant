...
所有LinkedIn範本寬度都以1200畫素為硬式編碼。

| 外觀比例 | Platform | 尺寸（畫素） | 備註 |
|-------------------|-----------------|------------|-------------------------------------------------------------------------------------|
| 正方形1:1 | 桌上型電腦、行動裝置 | 1200 x 1200 | 最通用。 適用於跨裝置和位置的一致外觀。 |
| 水準1.91:1 | 桌上型電腦 | 1200 x 628 | 標準橫向格式。 通常用於贊助內容和動態消息廣告。 |
| 垂直1:1.91 | 行動 | 1200 x 2292 | 高垂直格式。 針對行動檢視進行最佳化，提供更優異的畫面顯示效果。 |
| 垂直2:3 | 行動 | 1200 x 1800 | 略低於1:1.91。適用於行動優先的行銷活動。 |
| 垂直4:5 | 行動 | 1200 x 1500 | 建議行動裝置使用。 平衡可見度和內容，通常會產生較高的影響力。 |
