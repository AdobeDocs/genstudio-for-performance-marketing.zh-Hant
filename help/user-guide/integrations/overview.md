...
GenStudio Photoshop在Adobe Photoshop中新增了一個面板，可讓使用者執行GenStudio for Performance Marketing動作，例如產生品牌內內容。

在[GenStudio Photoshop Photoshop](photoshop-plugin.md)頁面中進一步瞭解GenStudio。
