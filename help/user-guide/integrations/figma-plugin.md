...
1. 在&#x200B;**[!UICONTROL 中，目標是什麼？]**，選取&#x200B;**[!UICONTROL 產生變數]**&#x200B;或&#x200B;**[!UICONTROL 翻譯]**，然後按一下&#x200B;**[!UICONTROL 完成設定]**&#x200B;按鈕。
   ![設定專案視窗](./setup-project.png){width="300" zoomable="yes"}
1. 選取要用於產生內容的[!DNL Brand]、[!DNL Persona]和[!DNL Product]。
1. 選取要產生的變數數目。
1. 使用「**[!UICONTROL 選取內容]**」下的按鈕，從您的資產中瀏覽並選擇影像。 最近新增的40個資產會先出現，您可以搜尋其他資產。 選取的影像會自動調整大小以符合您的範本。
...
已在外掛程式面板中建立ZIP檔案，或在GenStudio **[!UICONTROL 中顯示]**&#x200B;開啟的連結。 使用ZIP連結來選擇儲存檔案的位置，或選取&#x200B;**[!UICONTROL 在GenStudio中開啟]**。
