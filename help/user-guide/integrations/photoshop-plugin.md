---
title: 適用於Adobe GenStudio for Performance Marketing的Photoshop外掛程式
description: 瞭解如何安裝、設定和使用GenStudio for Performance Marketing的Photoshop外掛程式。
...
# GenStudio for Performance Marketing的Photoshop外掛程式

GenStudio for Performance Marketing Photoshop外掛程式會在Adobe Photoshop中新增面板，讓您產生品牌內內容。
...
1. 在Adobe Exchange中搜尋Photoshop的&#x200B;**GenStudio外掛程式**。
1. 依照提示安裝外掛程式。
...
圖形框架可以轉換為Photoshop檔案並匯出以與Photoshop外掛程式一起使用。 若要瞭解如何轉換框架，請參閱Figma外掛程式頁面中的[將Figma框架轉換成Photoshop](figma-plugin.md#convert-figma-frames-to-photoshop)區段。
