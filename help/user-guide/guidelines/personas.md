...
| 指引類別 | 指引範例 | 最佳做法 |
| ------------------| :---------- |-------------|
| 角色名稱 | 代表客製化產生之行銷資料的特定受眾區段 | 新增簡潔明瞭的角色名稱。<br><br>_範例_：「零售業的CMO」、「未來的護理學生」、「新的儲蓄帳戶客戶」 |
| 說明 | 定義關鍵特性、需求和行為的簡短摘要 | 使用簡潔的語言清楚描述角色和獨特的對象細分（1-2個句子）。<br><br>著重於驅動此對象區段的因素（需求、核心特徵等）<br><br>保持簡潔，避免深層人口統計資料或額外資訊。 |
| 訊息喜好設定 | 與特定角色產生共鳴的偏好通訊樣式清楚摘要 | 定義角色不重複的傳訊需求和動機，著重於角色偏好的接收通訊以及與通訊互動的方式。<br><br>在清單中提供特定的傳訊偏好設定（每個清單專案1-2個句子）。<br><br>將清單限製為總共10個或更少的句子，以確保強調最關鍵的資訊。<br><br>_範例_： 「技術精湛專業人員的傳訊偏好設定：<li>偏好簡潔、無術語的溝通。</li><li>積極回應資料導向分析和可行建議。</li><li>偏好使用資訊圖形和圖表等視覺效果，以快速掌握複雜的資訊。</li><li>以誠實、直截了當的方法重視透明度。</li>&quot; |
