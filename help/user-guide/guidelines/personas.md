...
| 訊息喜好設定 | 與特定角色產生共鳴的偏好通訊樣式清楚摘要 | 定義角色獨特的訊息需求和動機，著重於角色偏好的通訊接收及互動方式。<br><br>在清單中提供特定的訊息偏好設定（每個清單專案1-2個句子）。<br><br>將清單限製為總共10個句子或更少，以確保標示出最關鍵的資訊。<br><br>_範例_： 「精通技術的專業人員的訊息偏好設定：<li>偏好簡潔、無術語的溝通。</li><li>積極回應資料導向分析和可行建議。</li><li>偏好使用資訊圖形和圖表等視覺效果，以快速掌握複雜的資訊。</li><li>以誠實、直截了當的方法重視透明度。</li>&quot; |
