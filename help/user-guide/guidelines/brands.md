...
| [!UICONTROL 編輯指南] | 定義製作品牌訊息最佳實務的溝通准則 | 使用正面用語（5-10准則）建立堅實的基礎。<br>_範例_：「使用簡單、可存取的語言」而非「避免使用行話」<br><br>提供明確且可操作的指引。 <br>_範例_：「將句子保留在20個字以內」而非「簡潔明瞭」<br><br>反映您的品牌風格，例如使用特定的語法偏好設定。 <br>_範例_：「使用長破折號而非冒號」、「使用句子大小寫」<br><br>製作維持輸出一致性的精確准則。 |
...
| 部分 | 頻道 | 說明 | 最佳做法 |
| ------------------| --------- | --------- | -------- |
| 一般 | 電子郵件、中繼、顯示廣告 | 第二個主旨行或電子郵件預覽文字 | 定義整體語調/情緒，以在整個電子郵件中保持一致（2-5准則）。<br>_範例_：「保持友善且平易近人的語調」、「避免過於正式的語言」<br><br> |
...
| 標題 | 電子郵件、中繼資料、顯示廣告、LinkedIn | 吸引讀者注意的標題或片語 | 針對語調、理想長度等提供具體指引（2-5個指引）。 在&#x200B;_範例_&#x200B;區段中加入先前成功的標題，以獲得更優質的輸出。<br>_範例_：「使用強式陳述式來吸引注意」 |
| 副標題 | 電子郵件、顯示廣告 | 吸引讀者注意的第二或第三個標題或片語 | 提供具體指引（2-5指南），定義語調、理想長度等。 在&#x200B;_範例_&#x200B;區段中新增先前成功的子標題，以獲得更優質的輸出。<br>_範例_：「使用強式陳述式來吸引注意」 |
| 說明 | LinkedIn | 定義整體膚色情緒的描述性片語 | 針對語調、理想長度等提供具體指引（2-5個指引）。 在&#x200B;_範例_&#x200B;區段中新增先前成功的說明，以獲得更好的品質輸出。<br>_範例_：「保持友善且平易近人的語調」 |
| 內文 | 電子郵件、中繼資料、顯示廣告、LinkedIn | 包括訊息、連結和影像的行銷內容 | 針對語調、理想長度等提供具體指引（2-5個指引）。 將先前成功的復本新增至&#x200B;_範例_&#x200B;區段，以獲得更好的品質輸出。<br>_範例_：「限製為80-100個字元」、「避免過多的首字母縮略詞」 |
| 影像上文字 | 中繼，LinkedIn | 有關語調、理想長度等的特定指引。 顯示在影像頂端的文字 | 針對語調、理想長度等提供特定指引（1-2個句子）。 將先前成功的文字新增至&#x200B;_範例_&#x200B;區段，以獲得更好的品質輸出。<br>_範例_：「專注當下」 |
| 行動號召(CTA) | 電子郵件、中繼、顯示廣告 | （行動號召）給讀取器的指示，它會啟發回應。 通常是一兩個字，例如`Get started` | 針對語調、理想長度等提供具體指引（2-5個指引）。 將先前成功的CTA新增至&#x200B;_範例_&#x200B;區段，以獲得更好的品質輸出。<br>_範例_：「請勿使用結尾標點符號」 |
