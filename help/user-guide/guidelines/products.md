...
| 價值主張 | 清楚的摘要（少於10個句子），說明產品如何解決問題、提供特定權益，以及提供價值 | 以引人入勝的語言清楚定義產品的優點/優點，強調與競爭對手的差異。<br><br>以清單格式提供值主張，並在清單開頭提供最重要的值prop。<br><br>_範例_：「XYZ的值主張：<br><li>將專案管理工作集中在一個直覺式的平台中，無需使用多種工具</li><li>提升團隊生產力高達30%</li><li>緊密整合您最愛的工具，確保順暢的工作流程</li><li>提供即時更新和共同作業功能，讓團隊保持一致性」</li> |
| 訊息喜好設定 | 清楚概述特定產品應如何溝通的偏好溝通樣式摘要 | 定義產品的獨特傳訊需求，以不同的通訊風格為重點。<br><br>在清單中提供特定的傳訊偏好設定（每個清單專案1-2個句子）。<br><br>將清單限製為總共20個句子或更少，以確保標示最關鍵的資訊。<br><br>_範例_： 「XYZ產品的傳訊偏好設定：<li>強調XYZ產品的尖端技術與創新功能。</li><li>以直截了當的方式強調本產品的價格實惠性和實用性，並著重於金錢的價值。</li>&quot; |
