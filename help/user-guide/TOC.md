...
+ AI助理 {#ai-assistants}
  ...
  + [連線AI小幫手](ai-assistants/connect-ai-assistants.md)
  + [使用AI助理](ai-assistants/use-ai-assistants.md)
  + [AI助理工具參考](ai-assistants/tools-reference.md)
+ 設定 {#settings}
...
+ 建立 {#create}
  ...
  + [TikTok體驗](create/tiktok-experiences.md)
  + [連線電視廣告](create/create-ctv.md)
  ...
  + [在範本中設定圖志交換](create/logo-swap-setup.md)
  + [建立電子郵件體驗](create/create-email-experience.md)
  + [建立Meta廣告體驗](create/create-meta-ad.md)
  + [建立Meta廣告體驗 — 輪播廣告](create/create-meta-carousel-ad.md)
  + [建立ChatGPT廣告體驗](create/create-chatgpt-ad.md)
...
+ 範本 {#templates}
  + [使用範本](templates/use-templates.md)
  ...
  + [使用快速範本](/help/user-guide/templates/express-templates.md)
...
+ 啟動 {#activation}
  ...
  + 付費媒體廣告 {#paid-media-ads}
    ...
    + [交易台](activation/activate-trade-desk-ad.md)
+ Insights {#insights}
  + [深入解析概觀](insights/overview.md)
  + [深入分析篩選器](insights/filter-views.md)
  + [行銷活動](insights/campaigns.md)
  + [已發佈的體驗詳細資料](insights/published-experiences.md)
  + [媒體](insights/media.md)
  + [廣告標籤](insights/ad-tags.md)
  + 屬性 {#attributes}
    + [關於屬性](insights/attributes.md)
...
+ 整合 {#integrations}
  ...
  + [GenStudio Photoshop外掛程式](integrations/photoshop-plugin.md)
