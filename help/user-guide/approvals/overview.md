...
* **與Adobe Workfront校訂整合**。 使用者可以從GenStudio for Performance Marketing存取Workfront Proof強大的檢閱及核准功能。 在GenStudio for Performance Marketing中檢閱的內容會同步至Workfront Proof，且檢閱評論和狀態會保留。[整合亮點](/help/user-guide/approvals/proof-integration.md)會識別Proof如何延伸GenStudio for Performance Marketing的核准工作流程。
